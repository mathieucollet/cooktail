...
public class ByCategoryResult extends AppCompatActivity {
    String theCategory ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.theCategory = this.getExtraString(savedInstanceState , "theCategory");
        ...
        requests.getCocktailsByCategory(this.theCategory);
    }
    ...
    void initVolleyCallback(){
        mResultCallback = new IResult() {
            ...
            public void notifySuccess(String requestType, JSONObject response) {
                ...
                Log.d("persoLOG", "_ByCategoryResult_ : " + retList.toString() );
            ...
            public void notifyError(String requestType, VolleyError error) {
                Toast.makeText(ByCategoryResult.this, "error ! "+ requestType , Toast.LENGTH_LONG).show();
            }
        };
    }
}
